...
def parse_cmd_line_args():
	parser = argparse.ArgumentParser(description='WISC_S14 functional and performance simulation script')
	...
	parser.add_argument('--ref_src_dir', type=str, required=False, default='ref', dest='ref_src_dir', help='WISC_S14 reference model source directory')
	parser.add_argument('--ref_vvp_binary', type=str, required=False, default='WISC.S14', dest='ref_vvp_binary', help='WISC_S14 reference model vvp binary file')
	parser.add_argument('--ref_sim_out', type=str, required=False, default='ref.sim_out', dest='ref_sim_out', help='WISC_S14 reference model simulation output file')
